...
@WebServlet(name = "CourseMedian", value = "/CourseMedian")
public class CourseMedian extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("action" , "CourseMedian");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Double markk = Mysql.getInstance().getMEDIAN(courseName);
        Course mark = new Course(courseName,markk);
        request.setAttribute("mark", mark);
        request.setAttribute("text", "MEDIAN");
